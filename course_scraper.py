...
def main():
	...
	source_path = os.path.join("C:/Users/hansi/Desktop/Projects/Optshine_Course_Recommender/coursera-courses-overview.csv")
	df = pd.read_csv(source_path)
	dh = DataHunter(df)
	df = dh.make_dataset()
	destination_path = os.path.join("C:/Users/hansi/Desktop/Projects/Optshine_Course_Recommender/coursera-individual-courses.csv")
